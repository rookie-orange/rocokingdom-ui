...
export const docsRecords: readonly DocsRecord[] = [
  ...
  {
    category: 'components',
    description: '计数、状态点和角标展示，可独立使用或包裹触发元素。',
    importName: 'Badge / BadgeIndicator',
    notes: [
      'count 为 0 默认隐藏，可用 showZero 展示零值。',
      'maxCount 只在数字 count 超过上限时显示溢出文案。',
      '带 children 时徽标定位在右上角，offset 可微调角标位置。',
    ],
    packageName: 'rocokingdom-ui',
    path: '/docs/components/badge',
    props: [
      {
        description: '徽标内容，支持数字、文本和任意 ReactNode。',
        name: 'count',
        type: 'ReactNode',
      },
      {
        defaultValue: 'false',
        description: '仅展示状态点，不展示 count 内容。',
        name: 'dot',
        type: 'boolean',
      },
      {
        description: '数字 count 超过上限时展示为 maxCount+。',
        name: 'maxCount',
        type: 'number',
      },
      {
        defaultValue: 'false',
        description: 'count 为 0 时仍然展示徽标。',
        name: 'showZero',
        type: 'boolean',
      },
      {
      ...
      {
        defaultValue: "'solid'",
        description: '徽标填充或描边形态。',
        name: 'variant',
        type: inputVariant,
      },
      {
        defaultValue: 'false',
        description: '为徽标底形增加投影。',
        name: 'shadow',
        type: 'boolean',
      },
      {
        description: '角标相对默认位置的 x/y 偏移。',
        name: 'offset',
        type: 'readonly [number, number]',
      },
    ],
    slug: 'badge',
    source: 'packages/ui/src/badge',
    status: 'stable',
    title: 'Badge',
  },
  {
  ...
  {
    category: 'components',
    description: '语义化当前位置层级导航，支持 asChild 路由链接。',
    importName:
      'Breadcrumb / BreadcrumbList / BreadcrumbItem / BreadcrumbLink / BreadcrumbPage / BreadcrumbSeparator / BreadcrumbEllipsis',
    notes: [
      'Breadcrumb 默认渲染 nav，并提供 aria-label。',
      'BreadcrumbLink 支持 asChild，可接入 TanStack Router Link 等路由链接。',
      'BreadcrumbPage 默认 aria-current="page"，用于标记当前页。',
    ],
    packageName: 'rocokingdom-ui',
    ...
    props: [
      ...
      {
        defaultValue: 'false',
        description: '使用 Radix Slot 把链接样式和语义透传给唯一子元素。',
        name: 'BreadcrumbLink.asChild',
        type: 'boolean',
      },
      {
        description: '普通链接目标；asChild 时由子元素接管。',
        name: 'BreadcrumbLink.href',
        type: 'string',
      },
      {
        defaultValue: "'page'",
        description: '当前页标记，默认符合 aria-current 页面语义。',
        name: 'BreadcrumbPage.aria-current',
        type: 'string',
      },
      {
        defaultValue: "'/'",
        description: '相邻路径之间的分隔内容。',
        name: 'BreadcrumbSeparator.children',
        type: 'ReactNode',
      },
      {
        defaultValue: "'More'",
        description: '折叠省略号的屏幕阅读器标签。',
        name: 'BreadcrumbEllipsis.label',
        type: 'string',
      },
    ],
    slug: 'breadcrumb',
    source: 'packages/ui/src/breadcrumb',
    status: 'stable',
    title: 'Breadcrumb',
  },
  {
  ...
  {
    category: 'components',
    description: 'Radix Slider 封装，提供范围选择、键盘交互和参考图样式。',
    importName: 'Slider',
    notes: [
      'value/defaultValue、onValueChange 与 onValueCommit 沿用 Radix Slider。',
    ...
    props: [
      {
        description: '受控数值数组；单滑块传一个值，范围选择传多个值。',
        name: 'value',
        type: 'number[]',
      },
      {
        description: '非受控初始数值数组。',
        name: 'defaultValue',
        type: 'number[]',
      },
      {
        description: '拖动过程中触发的值变更回调。',
        name: 'onValueChange',
        type: '(value: number[]) => void',
      },
      {
        description: '拖动提交时触发的值变更回调。',
        name: 'onValueCommit',
        type: '(value: number[]) => void',
      },
      {
      ...
      {
        defaultValue: "'middle'",
        description: '轨道厚度和滑块尺寸档位。',
        name: 'size',
        type: sizePreset,
      },
      {
        defaultValue: "'stoneMuted'",
        description: '滑轨材质。',
        name: 'trackMaterial',
        type: materialPreset,
      },
      ...
      {
        description: '滑块的可访问名称，范围滑块可按 index 返回不同标签。',
        name: 'thumbAriaLabel',
        type: 'string | ((index: number) => string)',
      },
    ],
    slug: 'slider',
    source: 'packages/ui/src/slider',
    status: 'stable',
    title: 'Slider',
  },
  {
