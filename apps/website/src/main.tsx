  ...
  return (
    <main className="showcase">
      <section className="showcase__shell">
        ...
        <section aria-labelledby="drawer-title" className="showcase__section">
          ...
          <div className="button-row">
            ...
            <Drawer
              description="size='full' 时抽屉铺满整个视口。"
              size="full"
              title="全屏抽屉"
              trigger={<Button shadow>全屏 Drawer</Button>}
            >
              <div className="showcase__drawer-copy">
                <h3>全屏抽屉</h3>
                <p>内容与弧形面板一起铺满视口，适合长公告或详情页。</p>
              </div>
            </Drawer>
          </div>
        </section>

        <section aria-labelledby="select-title" className="showcase__section">
