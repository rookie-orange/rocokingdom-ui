...
test('supports semantic materials for lightweight controls', () => {
  ...
  expect(toggleGroupCss).toContain('--rk-material-background: var(--rk-primary-soft);')
  expect(toggleGroupCss).toContain('--rk-material-color: var(--rk-on-primary-soft);')
  expect(toggleGroupCss).toContain('--rk-material-background: var(--rk-primary-muted);')
  expect(toggleGroupCss).toContain('--rk-material-color: var(--rk-on-primary-muted);')
  expect(toggleGroupCss).toContain('--rk-material-background: var(--rk-primary-strong);')
  expect(toggleGroupCss).toContain('--rk-material-color: var(--rk-on-primary-strong);')
  expect(toggleGroupCss).toContain('--rk-material-background: var(--rk-success);')
  expect(toggleGroupCss).toContain('--rk-material-color: var(--rk-on-success);')
  expect(toggleGroupCss).toContain('--rk-material-background: var(--rk-danger);')
  expect(toggleGroupCss).toContain('--rk-material-color: var(--rk-on-danger);')
